...
parser.add_argument('--split',
                    default='simple',
                    choices=[None, 'simple', 'add_jump', 'jump', 'turn_left', 'turn_up', 'turn_up_jump_turn_left',
...
if __name__ == '__main__':
    ...
    logging.basicConfig(level=logging.DEBUG, filename=os.path.join(model_path, "train.log"), filemode="a+",
        ...
        if iteration % args.save_freq == 0:
            ...
            if args.validation_size > 0.:
                ...
                if val_acc > best_acc:
                    ...
                    logging.info('Best validation accuracy at iteration %s: %s' % (iteration + 1, val_acc))
